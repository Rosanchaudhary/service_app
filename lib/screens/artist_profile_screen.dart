...
import 'package:flutter_project/screens/widgets/artist_profile_gallery_widget.dart';
import 'package:flutter_project/screens/widgets/artist_profile_info_widget.dart';
import 'package:flutter_project/screens/widgets/artist_profile_reviews_widget.dart';
import 'package:flutter_project/screens/widgets/artist_profile_services_widget.dart';
  ...
  void didChangeDependencies() {
    if (isInit) {
      Provider.of<Auth>(context, listen: false)
          .getArtistInfo(Global.currentUID.toString())
          .then((value) {
        setState(() {
          isInit = false;
        });
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (ctx) => EditArtistProfileScreen(
                                      ...
                                      lati: artist.latitude != null
                                          ? double.parse(artist.latitude)
                                          : 0.0,
                                      longi: artist.longitude != null
