...
import 'package:flutter_project/models/applied_job.dart';
import 'package:flutter_project/models/artist_chat.dart';
import 'package:flutter_project/models/booking.dart';
import 'package:flutter_project/models/earings.dart';
import 'package:flutter_project/models/job.dart';
import 'package:flutter_project/models/ticket.dart';
import 'package:flutter_project/models/ticket_comment.dart';
...
class JobProvider with ChangeNotifier {
  ...
  Future<void> getCurrentBookingsArtist() async {
    ...
    try {
      final response =
          await http.post(Uri.parse(url), body: {'artist_id': _userId});
      final body = json.decode(response.body) as Map<String, dynamic>;
      print('${body['message']}');
